---
layout: post
title: "在阿里云 ACK 上部署 Jenkins 控制器"
date: 2026-04-26 10:00:00 +0800
categories: [jenkins, 架构]
tags: [jenkins, 架构, 部署, kubernetes, 阿里云]
description: "基于阿里云 ACK（Kubernetes）部署 Jenkins 控制器与 Agent 的端到端手册。"
slug: jenkins-deploy-aliyun-ack
---
...
- LDAP/AD 信息齐备（见 [design.md §6]({% post_url 2026-04-26-jenkins-design %})）。
